                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-6">
                                <form id="downloadForm" class="mb-5"
                                    action="{{ route('PdfchefDepartementController') }}" method="post">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="hidden" name="id_ins" value="4">
                ...
                form.addEventListener('submit', function(event) {
                    ...
                    fetch(form.action, {
                        ...
                        .then(blob => {
                            ...
                            a.href = url;
                            a.download =
                                "Candidature pour Chef de département .pdf"; // Changez le nom du fichier si nécessaire
