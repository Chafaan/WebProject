                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="{{ route('conseilEtablissement') }}">Conseil
                                    établissemnet</a>
                            </li>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-6">
                                <form id="downloadForm" class="mb-5"
                                    action="{{ route('PdfCommissionScientifiqueController') }}" method="post">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="hidden" name="id_ins" value="3">
                ...
                form.addEventListener('submit', function(event) {
                    ...
                    fetch(form.action, {
                        ...
                        .then(blob => {
                            ...
                            a.href = url;
                            a.download =
                                "Candidature pour la commision scinetifique.pdf"; // Changez le nom du fichier si nécessaire
