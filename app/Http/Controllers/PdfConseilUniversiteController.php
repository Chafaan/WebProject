...
class PdfConseilUniversiteController extends Controller
{
    public function ajouterInformations(Request $request)
    {
        ...
        switch ($data->grade->libelle) {
            case 'PA':
                $cheminFichier = storage_path('app/public/pdf/univ_PA.pdf');
                break;
            case 'PH':
                $cheminFichier = storage_path('app/public/pdf/univ_PH.pdf');
                break;
            case 'PES':
                $cheminFichier = storage_path('app/public/pdf/univ_PES.pdf');
                break;
            case 'admin':
                $cheminFichier = public_path('storage/pdf/univ_ADMIN.pdf');
                break;
            }
