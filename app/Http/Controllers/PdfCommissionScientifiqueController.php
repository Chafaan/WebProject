...
class PdfCommissionScientifiqueController extends Controller
{
    public function ajouterInformations(Request $request)
    {
        ...
        switch ($data->grade->libelle) {
            case 'PA':
                $cheminFichier = storage_path('app/public/pdf/Commission_Scientifique_PA.pdf');
                break;
            case 'PH':
                $cheminFichier = storage_path('app/public/pdf/Commission_Scientifique_PH.pdf');
                break;
            case 'PES':
                $cheminFichier = storage_path('app/public/pdf/Commission_Scientifique_PES.pdf');
                break;
            }
